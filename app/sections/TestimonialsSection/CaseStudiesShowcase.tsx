...
export default function CaseStudiesShowcase({ data, caseStudiesBlock }: any) {
  ...
  if(data === undefined || caseStudiesBlock === undefined || caseStudiesBlock.length === 0) {

    return (
      <section className="container overflow-hidden px-4 sm:px-6 lg:px-4 py-12 mx-auto">
        <div className="flex flex-col items-center justify-center">
          <h2 className="text-2xl sm:text-3xl font-semibold tracking-tighter text-stone-950 mb-4">
