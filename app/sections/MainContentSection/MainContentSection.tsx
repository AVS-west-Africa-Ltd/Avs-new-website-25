...
export const HeaderSection = () => {
  ...
  // Navigation menu items data with links
  const navItems = [
    { label: "Home", href: "/" },
                ...
                {navItems.map((item, index) => {
                  ...
                  return (
                    <NavigationMenuItem key={index}>
                      <Link href={item.href} legacyBehavior passHref>
                        <NavigationMenuLink
                          className={`relative w-fit font-normal text-[15px] tracking-[-0.30px] leading-[19.5px] whitespace-nowrap cursor-pointer transition-colors ${
                            isActive 
                              ? "text-[#0f0f0f] font-medium"
                              : "text-[#0f0f0fa6] hover:text-black"
                          }`}
                        >
                          {item.label}
                        </NavigationMenuLink>
                ...
                return (
                  ...
                  >
                    <Link
                      ...
                      className={`block py-3 px-4 text-lg ${
                        isActive
                          ? "text-[#0f0f0f] font-medium bg-gray-200"
                          : "text-[#0f0f0fa6]"
                      } hover:bg-gray-200 rounded-lg transition-colors`}
                      onClick={() => setMobileMenuOpen(false)}
                    >
